...
export default async function Page({searchParams}:{searchParams:Promise<{jenis?:string}>}){
 ...
 const d={muridNama:"MURID CONTOH",muridKp:"000000000000",muridKelas:"4 BESTARI",kelas:"4 BESTARI",penjagaNama:"PENJAGA CONTOH",penjagaKp:"000000000000",alamat:"ALAMAT CONTOH UNTUK UJIAN PAPARAN",telefon:"0000000000",bersetuju:true,penyakit:PENYAKIT.map(()=>({ada:false,catatan:""}))};
